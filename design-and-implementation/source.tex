...
\bnfprod{funtion name}{\bnfts{labda} \bnfor \bnfts{func} \bnfsp \bnftd{white space} \bnfsp \bnfpn{name} \bnfor \bnfts{local} \bnfsp \bnftd{white space} \bnfsp \bnfpn{name} \bnfor \bnfpn{name}}\\
